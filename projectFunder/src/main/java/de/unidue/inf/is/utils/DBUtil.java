...
public final class DBUtil {
    ...
    public static Connection getExternalConnection() throws SQLException {
		...
		String user = "dbp027"; 
				//properties.getProperty("gruppenname");
		String pass = "teu7uw3i"; 
				//properties.getProperty("passwort");
		String rechnername = "cronus";
				//properties.getProperty("rechnername");
		String database = "funding"; 
